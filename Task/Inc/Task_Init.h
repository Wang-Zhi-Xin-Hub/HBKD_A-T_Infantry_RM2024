 ...
 *
 * CAN1:拨弹盘2006电机（C610电调ID:1）(发送ID：0X200[0] 接收ID：0X201)<br>
 *      两个摩擦轮3508电机(C620电调ID：2[LEFT] 3[RIGHT]) （发送ID：0X200[1][2] 接收ID：0X202 0X203）
 *
 * CAN2:上下板通信(上板发送ID：0X110（底盘速度）0X120（机构状态）,下板发送ID：0X101（上板所需裁判系统信息）)(线过滑环，双线备用))<br>
 *      两个云台6020电机(ID：1[PITCH] 2[YAW])    (发送ID：0X1FF[0][1] 接收ID：0X205 0X206）（YAW轴电机CAN线过滑环连上板CAN2)
 *
 * USART1:NDJ6遥控器<br>
 * USART2:WT931陀螺仪
 *
